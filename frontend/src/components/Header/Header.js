    ...
    <HeaderContainer>
      <IconButton>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          <Box sx={{ fontSize: iconSize, marginRight: '20px', marginLeft: '30px', color: '#D1D0C5' }}>
            <FontAwesomeIcon icon={faStopwatch} color="#E2B714" />
          </Box>
          <Box sx={{ color: '#D1D0C5' }}>
            <div style={{ textAlign: 'left', fontWeight: 'bolder', fontSize: iconSize / 2.4, lineHeight: '1.5', fontFamily: 'JetBrains Mono, monospace' }}>
              Speed <br />Reader
            </div>
          </Box>
        </Box>
      </IconButton>
      <IconButton style={{ fontSize: iconSize/1.8, marginRight: iconSize/1.2, marginLeft: '30px', color: '#D1D0C5' }}>
