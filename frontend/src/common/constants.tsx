export const STANDARD_MODE_1 = "standard";
export const STANDARD_MODE_2 = "standard";
export const ADAPTIVE_MODE = "adaptive";
export const SUMMARISED_ADAPTIVE_MODE = "summarised adaptive";
