...
const questions: Question[] = [
    {
        ...
        options: ["he was hungry", "to get to the other side faster", "he saw a chic"],
        correctIndex: 1,
    },
    {
...
const QuizView = () => {
    const [selectedOptions, setSelectedOptions] = useState<(number | null)[]>(new Array(questions.length).fill(null));
    ...
    const getOptionClass = (questionIndex: number, optionIndex: number) => {
        ...
        const isCorrectOption = questions[questionIndex].correctIndex === optionIndex;
        const isIncorrectSelected = selectedOptionIndex !== null && selectedOptionIndex !== questions[questionIndex].correctIndex;
            ...
            <div className="quiz-questions-screen">
                <div className="quiz-questions-container">
                    {questions.map((question, index) => (
                        ...
                        >
                            <JetBrainsMonoText text={"Q. " + question.text} size={35} color="#D1D0C5" />
                            <div className="options-container">
                                ...
                                >
                                    <JetBrainsMonoText text={option} size={25} color="#FEFAD4   " />
                                </div>
                                ))}
                            </div>
                        </div>
            ...
            {allQuestionsAnswered && (
                <div className="results-section" id="results-section">
                    <div className="results-content">
                        <JetBrainsMonoText text={"Congratulations!"} size={45} color="#D1D0C5" />
                        <JetBrainsMonoText text={"Your Score: "+score+"/"+questions.length} size={35} color="#D1D0C5" />
                    </div>
                    <IconButton
                        sx={{
                    ...
                    >
                        <Link to="/pre-game" style={{ textDecoration: 'none', color: 'white' }}>
                            <Box
                                sx={{
